...
# Streamlit app
def main():
    st.title("Project-Specific Chatbot with SQL Query Support")
    st.write("Upload project-related files, ask questions, or run SQL queries on your data.")

    # File upload
    uploaded_files = st.file_uploader(
        "Upload your project files (CSV/Excel/PDF)", 
        type=["csv", "xlsx", "pdf"], 
